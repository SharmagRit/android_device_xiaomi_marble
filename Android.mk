...
WLANMDSP_SYMLINKS := $(TARGET_OUT_VENDOR)/firmware/
$(WLANMDSP_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
...
VNDK_SYMLINKS := $(TARGET_OUT_VENDOR)/lib/vndk
$(VNDK_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	@echo "Creating VNDK LIB symlinks: $@"
	@mkdir -p $@
	$(hide) ln -sf apex/com.android.vndk.v32/lib/libstagefright_omx.so $@/libstagefright_omx.so
